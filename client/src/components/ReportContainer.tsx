...
export const ReportContainer: React.FC<ReportContainerProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-xl print-container">
      ...
      <footer className="border-t border-slate-200 dark:border-slate-700 py-6 px-6 no-print">
